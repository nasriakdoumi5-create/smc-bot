  ...
  return (
    <>
      <div className="bg-primary text-white text-xs text-center py-2 px-4 font-medium">
        🐾 Free Shipping on orders €40+ | 10% off with code <span className="font-bold">PAWS10</span>
      </div>
      ...
      <nav className="bg-white shadow-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link href="/wishlist" className="relative p-2 hover:bg-secondary rounded-lg transition-colors">
        ...
        {mobileOpen && (
          <div className="md:hidden bg-white border-t px-4 py-4 flex flex-col gap-4 text-sm font-medium">
            ...
            <Link href="/wishlist" onClick={() => setMobileOpen(false)}>Wishlist ❤️</Link>
          </div>
        )}
      </nav>
    </>
