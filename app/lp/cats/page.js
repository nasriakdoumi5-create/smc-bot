...
const PRODUCTS = [
  ...
  },
  {
    ...
    stars: 4.8,
    reviews: 174,
    href: '/product/tabby-cat-phone-case',
  },
  {
    id: '5',
    name: 'Custom Cat Case',
    price: 35,
    originalPrice: 50,
    image: 'https://picsum.photos/seed/custompet2/600/600',
    badge: 'Your Photo',
    stars: 4.9,
    reviews: 143,
...
const REVIEWS = [
  { name: 'Camille D.', location: 'Paris', text: 'My black cat case is stunning. The detail in the print is unreal — Luna looks just like herself!', stars: 5 },
  { name: 'Ingrid B.', location: 'Stockholm', text: 'I get asked about my phone case everywhere. Finally a way to show off my tabby cat wherever I go.', stars: 5 },
  { name: 'Marco F.', location: 'Milan', text: 'Bought the custom case and uploaded my own cat photo. The quality blew me away. Fast delivery too!', stars: 5 },
];
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setShoppers(n => {
        ...
        return Math.min(55, Math.max(15, n + delta));
      });
    }, 4000);
    return () => clearInterval(interval);
  }, []);

  const CTA_HREF = '/products?category=cats&coupon=PAWS10';
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section
        ...
        style={{ background: 'linear-gradient(160deg, #1A1A2E 0%, #2D6A4F 60%, #52B788 100%)' }}
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-green-100 mb-10 max-w-2xl mx-auto leading-relaxed">
            Cats don't care about much — but you do. Give them the spotlight they deserve on the one thing you carry everywhere.
          </p>
        ...
        <div className="relative z-10 mt-16 flex gap-4 justify-center flex-wrap">
          {PRODUCTS.map(p => (
            <div
              key={p.id}
              className="w-28 h-28 md:w-36 md:h-36 rounded-2xl overflow-hidden shadow-2xl border-2 border-white/30 hover:scale-105 transition-transform"
            >
      ...
      <div className="bg-yellow-400 text-yellow-900 py-3 px-4 text-center font-bold text-sm md:text-base">
        ⭐ 4.9/5 — Over 5,000 Happy Cat Owners Across Europe Love Their PawCase
      </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-20">
        <div className="text-center mb-14">
          <p className="text-accent font-bold text-sm uppercase tracking-widest mb-3">Our Cat Collection</p>
          <h2 className="text-4xl md:text-5xl font-extrabold text-dark mb-4">
            Made for Cat Lovers. Made to Last.
          </h2>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-dark mb-6 leading-tight">
            "Every glance at my phone makes me smile — my cat is right there."
          </h2>
          <p className="text-gray-600 text-xl mb-8 leading-relaxed">
            Cat owners across Europe are turning their most-used accessory into a daily reminder of the one who rules their home. Your cat deserves that spotlight.
          </p>
          <Link
            href={CTA_HREF}
          ...
          >
            Get Your Cat's Case — 30% Off Today <span>→</span>
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TRUST_BADGES.map(b => (
            <div
              key={b.title}
              className="flex flex-col items-center text-center bg-white rounded-2xl p-8 shadow-md border border-gray-100"
            >
      ...
      <section className="bg-secondary py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-extrabold text-dark">What Cat Owners Are Saying</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {REVIEWS.map((r, i) => (
      ...
      <section
        className="py-20 px-4 text-center"
        style={{ background: 'linear-gradient(160deg, #1A1A2E 0%, #2D6A4F 100%)' }}
      >
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-green-200 text-lg mb-8">
            Join 5,000+ cat lovers across Europe. 30% off today only with code{' '}
          ...
          >
            Get Your Cat's Case Now <span>→</span>
          </Link>
